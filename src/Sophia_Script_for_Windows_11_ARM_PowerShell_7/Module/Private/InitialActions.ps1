...
function InitialActions
{
	...
	$Host.UI.RawUI.WindowTitle = "Sophia Script for Windows 11 v7.1.6 (Arm | PowerShell 7) | Made with $([System.Char]::ConvertFromUtf32(0x1F497)) of Windows | $([System.Char]0x00A9) Team Sophia, 2014$([System.Char]0x2013)2026"
...
"@
	...
	@("Microsoft.WindowsStore", "MicrosoftWindows.Client.CBS") | ForEach-Object -Process {
		...
		{
			Write-Information -MessageData "" -InformationAction Continue
			Write-Warning -Message (($Localization.UWPComponentsMissing -f $_), $Localization.ReinstallWindowsWarning -join " ")
			Write-Information -MessageData "" -InformationAction Continue
