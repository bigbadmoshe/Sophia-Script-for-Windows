...
UnsupportedOSBuild                        = Skrypt obsługuje tylko system Windows 10 Enterprise LTSC 2021. Używasz systemu {0} {1}. Uruchom odpowiedni skrypt w zależności od wersji systemu Windows.
