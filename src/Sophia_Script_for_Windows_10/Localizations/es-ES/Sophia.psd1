...
UnsupportedOSBuild                        = El script sólo es compatible con Windows 10 22H2. Estás usando Windows {0} {1}. Ejecuta el script adecuado según la edición de Windows.
...
ReinstallWindowsWarning                   = Reinstale Windows utilizando sólo una imagen ISO original.
Win10TweakerWarning                       = Probablemente su sistema operativo fue infectado a través del backdoor Win 10 Tweaker.
TweakerWarning                            = La estabilidad del sistema operativo Windows puede haberse visto comprometida al utilizar el {0}.
...
ESUProgramEnrollment                      = Windows 10 dejó de recibir soporte técnico el 14 de octubre de 2025. Tu PC podría ser vulnerable a software malicioso, troyanos y vulnerabilidades de día cero. ¿Deseas inscribirte en el programa de Actualizaciones de Seguridad Extendidas para Consumidores (ESU) para recibir actualizaciones hasta 2028 utilizando TSforge de Microsoft Activation Scripts (MAS)?
