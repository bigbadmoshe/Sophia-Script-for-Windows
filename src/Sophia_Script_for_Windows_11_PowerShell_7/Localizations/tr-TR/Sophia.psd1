...
UnsupportedOSBuild                        = Komut dosyası Windows 11 25H2 ve üstünü destekler. {0} {1} kullanıyorsunuz. Windows sürümüne göre doğru komut dosyasını çalıştırın.
...
ReinstallWindowsWarning                   = Yalnızca orijinal bir ISO görüntüsü kullanarak Windows'u yeniden yükleyin.
Win10TweakerWarning                       = Muhtemelen işletim sisteminize Win 10 Tweaker arka kapısı yoluyla bulaştı.
TweakerWarning                            = Windows işletim sistemi kararlılığı, {0} betiği kullanılarak tehlikeye atılmış olabilir.
...
CopilotPCSupport                          = Bilgisayarınızda yerleşik bir yapay zeka hızlandırıcısı (NPU) bulunmadığından, Windows'un yapay zeka ile ilgili işlevleri desteklenmemektedir. Windows ilkelerini kullanarak herhangi bir şeyi devre dışı bırakmanıza gerek yoktur. Yalnızca Geri Çağırma işlevi ve Copilot uygulaması kaldırılacaktır.
