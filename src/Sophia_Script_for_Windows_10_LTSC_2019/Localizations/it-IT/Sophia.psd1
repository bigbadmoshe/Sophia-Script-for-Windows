...
UnsupportedOSBuild                        = Lo script supporta solo Windows 10 Enterprise LTSC 2019. Stai utilizzando {0} {1}. Esegui lo script corretto in base alla versione di Windows.
