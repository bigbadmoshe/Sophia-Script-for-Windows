...
UnsupportedOSBuild                        = Skrypt obsługuje system Windows 11 25H2 i nowsze wersje. Używasz systemu {0} {1}. Uruchom odpowiedni skrypt w zależności od wersji systemu Windows.
...
ReinstallWindowsWarning                   = Zainstaluj ponownie system Windows, używając tylko oryginalnego obrazu ISO.
...
TweakerWarning                            = Stabilność systemu Windows mogła zostać naruszona przez użycie {0}.
...
CopilotPCSupport                          = Twój komputer nie posiada wbudowanego akceleratora sztucznej inteligencji (NPU), więc nie obsługuje funkcji związanych ze sztuczną inteligencją w systemie Windows. Nie ma potrzeby wyłączania niczego za pomocą zasad systemu Windows. Usunięte zostaną jedynie funkcja "Recall" oraz aplikacja Copilot.
