...
UnsupportedOSBuild                        = El script sólo es compatible con Windows 11 Enterprise LTSC 2024. Estás usando Windows {0} {1}. Ejecuta el script adecuado según la edición de Windows.
