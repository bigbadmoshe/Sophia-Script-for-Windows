...
UnsupportedOSBuild                        = Скрипт поддерживает только Windows 11 Enterprise LTSC 2024. Вы используете {0} {1}. Запустите скрипт в зависимости от вашей версии Windows.
