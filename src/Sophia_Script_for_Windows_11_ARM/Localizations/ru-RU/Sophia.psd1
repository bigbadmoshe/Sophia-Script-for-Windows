...
UnsupportedOSBuild                        = Скрипт поддерживает Windows 11 25H2 и выше. Вы используете {0} {1}. Запустите скрипт в зависимости от вашей версии Windows.
...
ReinstallWindowsWarning                   = Переустановите Windows, используя только подлинный ISO-образ.
Win10TweakerWarning                       = Windows был заражен трояном через бэкдор в Win 10 Tweaker.
TweakerWarning                            = Стабильность Windows могла быть нарушена использованием {0}.
...
ControlledFolderAccessEnabledWarning      = Вы включили Контролируемый доступ к папкам. Пожалуйста, отключите его и повторите попытку.
...
CopilotPCSupport                          = Ваш ПК не имеет встроенного ИИ-ускоритель (NPU), поэтому отсутствует поддержка каких-либо функций, связанных с ИИ Windows. Нет необходимости что-либо выключать с помощью политик Windows. Только функция Recall и приложение Copilot будут удалены.
