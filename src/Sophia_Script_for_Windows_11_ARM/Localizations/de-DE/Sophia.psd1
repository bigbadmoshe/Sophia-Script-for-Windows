...
UnsupportedArchitecture                   = Sie verwenden eine CPU mit "{0}"-basierter Architektur. Dieses Skript unterstützt nur CPUs mit Arm-Architektur. Laden Sie die für Ihre Architektur geeignete Skriptversion herunter und führen Sie sie aus.
UnsupportedOSBuild                        = Das Skript unterstützt Windows 11 25H2 und höher. Sie verwenden Windows {0} {1}. Führen Sie das für Ihre Windows-Version geeignete Skript aus.
...
CopilotPCSupport                          = Ihr PC verfügt über keinen integrierten KI-Beschleuniger (NPU), daher werden keine Windows-KI-Funktionen unterstützt. Es ist nicht erforderlich, etwas über Windows-Richtlinien zu deaktivieren. Lediglich die Recall-Funktion und die Copilot-Anwendung werden entfernt.
