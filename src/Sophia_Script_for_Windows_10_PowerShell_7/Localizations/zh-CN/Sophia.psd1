...
ReinstallWindowsWarning                   = 僅使用正版 ISO 映像重新安裝 Windows。
...
WindowsComponentStabilityDisrupted        = 已在"{0}"组件中检测到一个不稳定问题。
UWPComponentsMissing                      = 缺少"{0}" UWP 组件。
DefenderComponentsMissing                 = 缺少 Microsoft Defender 的"{0}"组件。
