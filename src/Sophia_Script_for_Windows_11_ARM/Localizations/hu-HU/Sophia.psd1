...
UnsupportedOSBuild                        = A szkript támogatja a Windows 11 25H2 és magasabb verziószámú operációs rendszereket. {0} {1}-et használsz. A Windows-verziónak megfelelő szkriptet futtassa.
...
CopilotPCSupport                          = A számítógépében nincs beépített NPU (AI gyorsító), ezért a Windows AI-hez kapcsolódó funkciók nem támogatottak. Nincs szükség semmilyen GPO-házirend letiltására. Csak a visszahívási funkció és a Copilot alkalmazás lesz eltávolítva.
