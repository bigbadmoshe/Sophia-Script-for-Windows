...
UnsupportedOSBuild                        = Скрипт поддерживает только Windows 10 Enterprise LTSC 2021. Вы используете {0} {1}. Запустите скрипт в зависимости от вашей версии Windows.
