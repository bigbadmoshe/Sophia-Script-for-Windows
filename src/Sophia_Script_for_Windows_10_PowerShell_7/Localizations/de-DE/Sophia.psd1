...
UnsupportedOSBuild                        = Das Skript unterstützt nur Windows 10 22H2. Sie verwenden Windows {0} {1}. Führen Sie das für Ihre Windows-Version geeignete Skript aus.
...
UpdateWarning                             = Sie verwenden Windows 10 {0}.{1}. Unterstützt wird Windows 10 {0}.{2} und höher. Führen Sie Windows Update aus und versuchen Sie es erneut.
...
ReinstallWindowsWarning                   = Installieren Sie Windows nur mit einem Original-ISO-Abbild neu.
Win10TweakerWarning                       = Wahrscheinlich wurde Ihr Betriebssystem über die Win 10 Tweaker-Hintertür infiziert.
TweakerWarning                            = Die Stabilität des Windows-Betriebssystems kann durch die Verwendung des {0} beeinträchtigt worden sein.
...
ESUProgramEnrollment                      = Der Support für Windows 10 endet am 14. Oktober 2025. Ihr PC ist möglicherweise anfällig für Schadsoftware, Trojaner und Zero-Day-Exploits. Möchten Sie sich für das Programm "Consumer Extended Security Updates" (ESU) anmelden, um über TSforge von Microsoft Activation Scripts (MAS) bis 2028 Updates zu erhalten?
...
TaskbarSmallIcons                         = Sie verwenden kleine Taskleisten-Schaltflächen.
...
HEVCInstalled                             = HEVC-Videoerweiterungen vom Gerätehersteller ist bereits installiert.
HEVCInstallNotification                   = HEVC-Videoerweiterungen vom Gerätehersteller wird installiert...
