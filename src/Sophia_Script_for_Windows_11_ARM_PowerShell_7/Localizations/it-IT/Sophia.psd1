...
CopilotPCSupport                          = Il tuo PC non dispone di un NPU (acceleratore AI) integrato, quindi non supporta le funzioni relative all'AI di Windows. Non è necessario disabilitare nulla utilizzando i criteri GPO. Verranno rimossi solo la funzione Recall e l'applicazione Copilot.
