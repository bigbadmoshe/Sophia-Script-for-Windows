...
function InitialActions
{
	...
	$Host.UI.RawUI.WindowTitle = "Sophia Script for Windows 11 LTSC 2024 v7.1.5 (PowerShell 7) | Made with $([System.Char]::ConvertFromUtf32(0x1F497)) of Windows | $([System.Char]0x00A9) Team Sophia, 2014$([System.Char]0x2013)2026"
