...
UnsupportedOSBuild                        = El script es compatible con Windows 11 25H2 y superiores. Estás usando Windows {0} {1}. Ejecuta el script adecuado según la edición de Windows.
...
CopilotPCSupport                          = Tu PC no cuenta con un acelerador de IA integrado (NPU), por lo que no es compatible con las funciones de IA de Windows. No es necesario desactivar nada mediante las políticas de Windows. Solo se eliminarán la función "Recall" y la aplicación Copilot.
