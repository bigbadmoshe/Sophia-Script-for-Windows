...
UnsupportedOSBuild                        = O script é compatível com o Windows 11 25H2 e superior. Você está usando o {0} {1}. Execute o script correto de acordo com a edição do Windows.
...
ReinstallWindowsWarning                   = Reinstale o Windows usando apenas uma imagem ISO genuína.
Win10TweakerWarning                       = Probabilmente il tuo sistema operativo è stato infettato tramite la backdoor Win 10 Tweaker.
TweakerWarning                            = A estabilidade do sistema operacional Windows pode ter sido comprometida pela utilização do {0}.
...
CopilotPCSupport                          = O seu PC não possui um acelerador de IA integrado (NPU), pelo que não há suporte para funções relacionadas com a IA do Windows. Não é necessário desativar nada através das políticas do Windows. Apenas a função Recall e a aplicação Copilot serão removidas.
