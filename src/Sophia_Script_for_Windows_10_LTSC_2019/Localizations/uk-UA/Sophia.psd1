...
UnsupportedOSBuild                        = Скрипт підтримує тільки Windows 10 Enterprise LTSC 2019. Ви використовуєте {0} {1}. Запустіть скрипт відповідно до вашої версії Windows.
...
ReinstallWindowsWarning                   = Перевстановіть Windows, використовуючи тільки справжній ISO-образ.
Win10TweakerWarning                       = Windows була заражена трояном через бекдор у Win 10 Tweaker.
TweakerWarning                            = Стабільність вашої ОС могла бути порушена використанням {0}.
