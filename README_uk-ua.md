...
Зроблено з <img src="https://raw.githubusercontent.com/farag2/Sophia-Script-for-Windows/main/img/heart.svg" height="17px"/> до Windows
...
Завантажте та розпакуйте в папку Завантаження останню версію `Sophia Script for Windows` з актуального [коміту](https://github.com/farag2/Sophia-Script-for-Windows/commits/main/) залежно від версій ваших Windows і PowerShell.
