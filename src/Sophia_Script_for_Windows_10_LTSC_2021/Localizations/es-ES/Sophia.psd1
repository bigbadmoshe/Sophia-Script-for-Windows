...
UnsupportedOSBuild                        = El script sólo es compatible con Windows 10 Enterprise LTSC 2021. Estás usando Windows {0} {1}. Ejecuta el script adecuado según la edición de Windows.
