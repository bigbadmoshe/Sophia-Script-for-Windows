...
ReinstallWindowsWarning                   = Ponovno instalirajte Windows koristeći samo originalnu ISO sliku.
Win10TweakerWarning                       = Valószínűleg az operációs rendszerét a Win 10 Tweaker backdoor segítségével fertőzték meg.
TweakerWarning                            = A Windows operációs rendszer stabilitását veszélyeztethette a {0}.
