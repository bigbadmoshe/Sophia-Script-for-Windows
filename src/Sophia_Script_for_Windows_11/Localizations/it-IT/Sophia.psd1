...
UnsupportedOSBuild                        = Lo script supporta Windows 11 25H2 e versioni successive. Stai utilizzando {0} {1}. Esegui lo script corretto in base alla versione di Windows.
...
ReinstallWindowsWarning                   = Reinstallare Windows utilizzando solo un'immagine ISO autentica.
Win10TweakerWarning                       = Probabilmente il tuo sistema operativo è stato infettato tramite una backdoor in Win 10 Tweaker.
TweakerWarning                            = La stabilità del sistema operativo Windows potrebbe essere stata compromessa dall'utilizzo dello {0}.
HostsWarning                              = Voci di terze parti trovate nel file %SystemRoot%\\System32\\drivers\\etc\\hosts.
