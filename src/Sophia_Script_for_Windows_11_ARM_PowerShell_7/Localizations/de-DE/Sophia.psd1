...
CopilotPCSupport                          = Ihr PC verfügt über keine integrierte NPU (KI-Beschleuniger), daher werden keine Windows-KI-bezogenen Funktionen unterstützt. Es ist nicht erforderlich, etwas mithilfe von GPO-Richtlinien zu deaktivieren. Die Recall-Funktion und die Copilot-Anwendung werden lediglich entfernt.
